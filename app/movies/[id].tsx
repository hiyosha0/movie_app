...
const MovieInfo = ({ label, value }: MovieInfoProps) => (
  <View className=" flex-col items-start justify-center mt-5">
    <Text className=" text-gray-300 font-normal text-sm">{label}</Text>
...
const MovieDetails = () => {
  ...
  return (
    <View className=" bg-primary flex-1">
      ...
      <TouchableOpacity
        className=" absolute bottom-5 left-0 right-0 mx-5 bg-accentText rounded-lg py-3.5 flex-row items-center 
      justify-center z-10"
        onPress={router.back}
      >
        <Image
